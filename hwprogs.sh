...
# define file array
files=( "lscpu" "lshw" "lspci" "lsscsi" "lsusb" "lsblk" "dmesg" "df" "pydf" "fdisk" "mount" "free" "dmidecode" "cat" "hdparm" "hwinfo" "inxi" )
...
do
	#clear
	CHOICES=$(whiptail --menu "Choose your pick" --title "Hardware information" --cancel-button "Done" $WHIPX $WHIPY \
	"1" "lscpu       - List CPU" \
